...
Identified top-performing products using the DENSE_RANK function.

### Time-Series Analysis

Compared sales performance and growth across different months.

### Aggregation and Metrics

Calculated total revenue and profit margins by product category.

### Subqueries and CTEs

Used subqueries and Common Table Expressions to break down complex business questions into manageable steps.
